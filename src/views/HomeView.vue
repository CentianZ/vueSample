...
import type { PerspectiveCamera, Scene, Renderer, AnimationMixer, Camera } from "three";
...
watch(lineOption, async (newOption, oldOption) => {
  lineChart.value && lineOption.value && lineChart.value.setOption(lineOption.value);
})
...
onMounted(() => {
  ...
  lineChart.value = echarts.init(document.getElementById("line-chart") as any as HTMLElement);
  lineOption.value && lineChart.value.setOption(lineOption.value);

  pieChart.value = echarts.init(document.getElementById("pie-chart") as any as HTMLElement);
  let pieOptionDay = {
    tooltip: {
      trigger: 'item'
    },
...
pieOption.value && pieChart.value.setOption(pieOption.value);
 watch(pieOption, async (newOption, oldOption) => {
   pieChart.value && pieOption.value && pieChart.value.setOption(pieOption.value);
 })
...
<template>
  <div style="background-color: #081623; background-size: cover; min-height: 100vh; margin: 0px; padding: 0px">
    <div class="top-bar">
      <div class="logo"><p class="title-font">LOGO</p></div>
      <div class="system-name"><p class="title-font">钢缆缺陷智检系统</p></div>
      <div class="clock">
        <div class="time"><p class="title-font">{{ currentTime }}</p></div>
        <div class="date"><p class="title-font" style="font-size: 12px">{{ currentDate }}</p></div>
      </div>
    </div>
    <el-row id="top">
      <el-col :span="16" id="top-left">
        <div style="align-content: left; margin: 0px; border: none; padding: 0px">
      ...
      <el-col :span="8" id="top-right">
        <el-row id="device-section" style="margin-top: 3vh">
          ...
          <el-col :span="15" id="device-info">
            ...
            <div style="background-color: #133B5E; margin-right: 1.67vw; display: flex; margin-top: 2vh">
              <p class="small-font" style="font-size: 18px; align-self: center; margin-left: 1vw">设备数量</p>
              <p class="small-font" style="font-size: 24px; align-self: center; margin-left: 11.5vw">{{ deviceNum }}</p>
              ...
              <el-col :span="8" id="normal">
                <div style="display: flex">
                  ...
                  <div style="text-align: left">
                    ...
                    <div style="display: flex">
                      <p class="small-font" style="font-size: 24px">6</p><p class="small-font" style="align-self: center">台</p>
                    </div>
                  </div>
                </div>
              </el-col>
              <el-col :span="8" id="need-clean">
                <div style="display: flex">
                  ...
                  <div style="text-align: left" >
                    ...
                    <div style="display: flex">
                      <p class="small-font" style="font-size: 24px">1</p><p class="small-font" style="align-self: center">台</p>
                    </div>
                  </div>
                </div>
              </el-col>
      ...
      <el-col :span="16" id="bottom-left">
        <div class="history-list">
          ...
          <div style="margin-top: 1.5vh">
            <el-table :data="tableData" :row-class-name="tableRow" 
              :header-cell-style="{ background: '#133B5E', border: 'none', fontSize: '16px', color: 'white', fontWeight: '700' }"
              style="--el-table-border-color: none;">
              <el-table-column prop="index" label="序号" min-width="6%" align="center" />
              <el-table-column prop="deviceId" label="设备ID" min-width="10%" align="center" />
              <el-table-column prop="cameraId" label="相机ID" min-width="8%" align="center" />
              <el-table-column prop="recordTime" label="记录时间" min-width="16%" align="center" />
              <el-table-column prop="defectType" label="缺陷类型" min-width="10%" align="center" />
              <el-table-column prop="defectLocation" label="缺陷位置" min-width="10%" align="center" />
              <el-table-column prop="image" label="图像" min-width="10%" align="center" >
<!--                <template #default="scope">-->
<!--                  <img src="@/assets/defect.png" style="width: 1.8vw; height: auto"/>&ndash;&gt;-->
<!--                   -->
<!--                </template>-->
                <template #default="scope">
                  <el-popover placement="top" :width="620" :hight="700" trigger="click">
                    <template #reference>
<!--                      <el-avatar src="@/assets/defect.png" style="width: 1.8vw; height: auto" />-->
                      <img src="@/assets/defect.png" style="width: 1.8vw; height: auto"/>
                    </template>

                    <template #default >
                      <img src="@/assets/defect.png" style="width: 600px; height:600px"/>
                      <div>

                          <el-button  type="success"  @click="handleEditRow(scope.$index)" >  确认缺陷 </el-button>
              ...
              <el-table-column prop="manualConfirmedResult" label="人工确认结果" min-width="14%" align="center" >
...
<!--                </editable-cell>-->
              ...
              <el-table-column prop="confirmedOwner" label="确认者身份" min-width="10%" align="center" />
            </el-table>
          </div>
        </div>
      </el-col>
        ...
        <div style="display: flex">
          ...
          <el-col :span="16"  >
                      ...
                      <div class="defect-table">
                             <el-table :data="defectData" :row-class-name="defectRow"
                               :header-cell-style="{ background: '#133B5E', border: 'none', fontSize: '16px', color: 'white', fontWeight: '700' }"
                               style="--el-table-border-color: none;">
                               <el-table-column prop="defectType" label="缺陷类型" min-width="100px" align="center" />
                               <el-table-column prop="defectNum" label="缺陷数量" min-width="100px" align="center" />
                     </el-table>
                   </div>
                   </el-scrollbar>
                   </div>
